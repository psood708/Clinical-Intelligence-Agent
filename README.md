...
- _"Extract clinical entities from this note: [paste text]"_
- _"Find cases similar to: 67yo male with ADHF and worsening CKD"_
- _"Summarize this discharge summary: [paste text]"_
